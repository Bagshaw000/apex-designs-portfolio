...
export default function Header() {
  ...
  return (
    <div onClick={handleShowMenu} className="w-[90vw] z-100 max-w-125    rounded-2xl font-bitcount fixed top-[2vh]  left-1/2 transform -translate-x-1/2  text-black  " style={reachedBottom ? {backgroundColor:"blue", color:"white"}:  {backgroundColor:"#ffffff33"}}>
      ...
      {!reachedBottom ? ( menu ?  <>
        ...
        < div className="p-5 text-center mt-15 w-fit md:w-[70%] mx-auto">
          <h1 className="text-xl font-bold mb-5"> Industry insight & agency updates</h1>
          <input type="text" name="" id="" className="bg-[#b8b8b833] h-10 w-full text-sm p-3 mb-3 rounded-lg text-center border-0 border-transparent active:border-0 focus:border-0" placeholder="brandon@synergisdesign.com"/>
