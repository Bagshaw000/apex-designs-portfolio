...
export default function HomeTag() {
  return (
    <div className=" h-screen w-screen min-h-fit bg-black px-[10vw] relative z-0 top-0">
      ...
      <div className="w-fit lg:max-w-full xl:max-w-[1200px] mx-auto lg:px-0 xl:px-[5vw] flex flex-col justify-end  bottom-0  items-start   h-[inherit] ">
        <p className="w-[inherit] leading-6 flex flex-wrap lg:flex-col  text-white">
          <h1 className="sm:font-outfit font-thin text-5xl w-full mb-[10px]  lg:text-6xl  ">
            <b className="font-medium lg:mb-[5px]">Shaping</b> Tomorrow’s
          </h1>
          <h1 className="sm:font-outfit font-thin text-5xl w-full mb-[60px] lg:text-6xl  ">
