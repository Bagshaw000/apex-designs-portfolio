          ...
          <RevealOnScroll to={transitionElement}>
            <div className="flex flex-col justify-between h-[300px] items-start mb-[50px] max-w-[1200px] lg:mx-auto lg:mb-[100px] lg:h-[350px]">
              ...
              <span className=" text-3xl font-thin lg:text-5xl">
                <b>This is</b> what <br className="hidden lg:block" />
                <b>we do</b> best
              </span>

              <div className="flex flex-row justify-between text-[12px] text-amber-500 w-[135px] items-center">
                <span>OUR SERVICES</span>
                <div className="w-[35px] h-[35px] bg-[#4242427e] rounded-[45px] animate-bounce flex flex-row justify-center items-center ">
        ...
        <div>
          <RevealOnScroll to={transitionElement}>
            <div className="text-[#42424298] text-xs flex flex-row  items-center font-light w-[300px] max-w-[90vw] mx-auto text-center my-[100px] md:text-right md:mr-[5vw]    ">
              ...
              <hr className="hidden lg:block lg:w-[100px] text-[#42424298] " />
            </div>
          </RevealOnScroll>
          <div className="text-black text-center font-thin text-2xl md:text-3xl mb-[50px]">
            <h2>
              <b className="font-medium">Let's make an</b>{" "}
              <TextType
                text={["impact", "impact"]}
                typingSpeed={100}
                deletingSpeed={50}
              ...
              <b className="font-medium">together.</b>
              <br className="md:hidden" /> <b className="font-medium">Ready</b>{" "}
              when you are
            </h2>
          </div>
